    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-50 dark:from-slate-900 dark:via-purple-950/20 dark:to-blue-950/30 flex flex-col p-4 md:p-8 overflow-hidden">
      ...
      <main className="container mx-auto flex-1 flex flex-col">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          <Card className="p-6 bg-gradient-to-br from-white to-blue-50 dark:from-slate-900 dark:to-blue-950/20 shadow-lg border-blue-100 dark:border-blue-900/20 flex flex-col items-center text-center">
          ...
          <Card className="p-6 bg-gradient-to-br from-white to-purple-50 dark:from-slate-900 dark:to-purple-950/20 shadow-lg border-purple-100 dark:border-purple-900/20 flex flex-col items-center text-center">
          ...
          <Card className="p-6 bg-gradient-to-br from-white to-indigo-50 dark:from-slate-900 dark:to-indigo-950/20 shadow-lg border-indigo-100 dark:border-indigo-900/20 flex flex-col items-center text-center">
        ...
        <Card className="flex-1 flex flex-col border shadow-xl overflow-hidden rounded-2xl bg-white/90 dark:bg-slate-950/90 backdrop-blur-sm">
          <ChatContainer />
        </Card>
      </main>
